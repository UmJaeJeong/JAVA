...
public class ReadExample01 {
   ...
   public static void main(String[] args) throws Exception {
      //W는 이스케이프 문자로써 경로를 입력시 WW를 하던지 아니면. /만 적어주면 된다.
      //이스케이프란 어떤 부호 또는 언어로부터 이탈하는 것. 즉, 기존의 패턴으로부터 탈출하는
      //것을 말한다. 아스키 문자 집합의 27번째 문자의 이름이다.
      
      //다형성 적용 예외 발생 할수 있으니 JVM에게 던짐.
      //InputStream is = new FileInputStream("C:\\test.txt");
      InputStream is = new FileInputStream("C:\\Users\\gjals\\OneDrive\\바탕 화면\\따오기\\수업자료\\test.txt");
      int readByte;
      ...
      while((readByte = is.read()) != -1) {
         ...
         //아스키코드값 출력(한글은 깨짐. 왜냐 한글은 2바이트니깐)
